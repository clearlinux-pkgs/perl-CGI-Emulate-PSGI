...
cp %{_builddir}/CGI-Emulate-PSGI-0.23/LICENSE %{buildroot}/usr/share/package-licenses/perl-CGI-Emulate-PSGI/82717a9c29ee8516411ec4760124809724b76c32
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.34.0/CGI/Emulate/PSGI.pm
/usr/lib/perl5/vendor_perl/5.34.0/CGI/Parse/PSGI.pm
